...
export default function CaseStudies() {
  ...
  const paginated = caseStudies.slice(
      ...
      <main className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
            Explore detailed breakdowns of how strategy, design, and execution created real results for organizations across Nepal.
          </p>
        </motion.div>
        ...
        <div className="flex items-center justify-between mb-8">
          <p className="text-sm text-muted-foreground">
            ...
            <span className="text-foreground font-semibold">
              ...
              {Math.min(page * ITEMS_PER_PAGE, caseStudies.length)}
            </span>{" "}
            of{" "}
            <span className="text-foreground font-semibold">
              {caseStudies.length}
              ...
              >
                 <div className="rounded-3xl overflow-hidden relative bg-card border border-border hover:border-primary/40 transition-all duration-300 shadow-lg hover:shadow-primary/20 hover:shadow-xl h-full">
                  ...
                  <div className="relative w-full h-52 overflow-hidden">
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t ${study.gradient} opacity-70`} />
